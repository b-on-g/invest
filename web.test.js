...
(function ($) {
    $mol_test({
        'norm_name: аптрим, пробелы, кириллическая Р'() {
            ...
            $mol_assert_equal($bog_invest_core.norm_name('АПРИ 2Р10'), $bog_invest_core.norm_name('АПPИ 2P10'));
        },
